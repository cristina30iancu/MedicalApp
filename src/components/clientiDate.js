...
export class CLientiDate extends Component {
  ...
  searchNumeClient() {
    ...
    .filter(t => t.numeUtilizator.toLowerCase()
    .includes(this.state.searchNumeClient.toLowerCase()))
    this.setState({
          ...
          <div class="col-sm-6">
            <div class="email-signature">
              <div class="signature-icon">
                ...
                < h2 style={{ fontFamily: "URW Chancery L " }}> Pagină clienți
                </h2>
          ...
          {currentTutorial ? (
            ...
            <div className="card-body">
              ...
              <div>
                <div>
                  <label>
                    <  strong style={{ color: "black  ", fontFamily: "URW Chancery L " }}>Nume Client: </strong>              {currentTutorial.numeUtilizator}
              ...
              <div>
                <label>
                  <strong >Email: </strong>                {currentTutorial.email}
              ...
              <div>
                ...
                <label>
                  <strong style={{ color: "black  ", fontFamily: "URW Chancery L " }}>Telefon:</strong>                 {currentTutorial.telefon}
